...
@Component({
  ...
  imports: [CatCardComponent, AdoptFormComponent],
  template: `
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="flex justify-between items-center mb-6">
        ...
        @if (catStore.availableSlots() > 0 && !showAdoptForm()) {
          ...
          >
            Adoptar michi ({{ catStore.availableSlots() }} slots disponibles)
          </button>
        }
      </div>
      ...
      @if (catStore.loading()) {
        <div class="text-center py-12 text-gray-500">Cargando michis...</div>
